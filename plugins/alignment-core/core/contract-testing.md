<!-- GENERATED FILE - do not edit. Source: src/core/contract-testing.md at the repo root; regenerate with: python scripts/build.py -->
...
Contract tests are generated **from the contract carrier** (`core/shape-engine.md` descriptor),
