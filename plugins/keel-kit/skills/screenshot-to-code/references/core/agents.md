...
(`references/core/decisions-ledger-spec.md` v0.9), so *what we feared* and *what happened* can be joined
...
pretending to would be the fake determinism `references/core/trust-axes.md` forbids.
