...
this skill that step already happened: they handed you the screenshot. When the direction is still
open rather than approved, the moment belongs to the `prototype` skill instead — that is where
throwaway code is the point, and this one starts on the far side of the election it earns.
