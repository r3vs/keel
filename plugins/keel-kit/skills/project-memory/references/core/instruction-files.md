...
|---|---|---|---|
| **ledger** (`references/core/ledger.md`) | the human's interview | the elected truth, with `flip_criteria` | yes — via this carrier |
...
ledger may elect anything** — see `references/core/assumptions.md` for what an agent does instead when it is
forced to assume.
