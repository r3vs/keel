<!-- GENERATED FILE - do not edit. Source: src/core/trust-axes.md at the repo root; regenerate with: python scripts/build.py -->
...
The provider split itself comes off the existing profile D (`references/core/model-tiers.md`), which was wired
...
degradation *looks* like success. `references/core/static-analysis.md` carries the concrete instance of this for
