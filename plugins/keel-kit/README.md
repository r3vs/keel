<!-- GENERATED FILE - do not edit. Source: src/readme/keel-kit.md at the repo root; regenerate with: python scripts/build.py -->

# keel-kit

**Twelve composable skills.** Each is useful on its own, in any task, on any codebase — and each is
