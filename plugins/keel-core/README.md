<!-- GENERATED FILE - do not edit. Source: src/readme/keel-core.md at the repo root; regenerate with: python scripts/build.py -->
...
`core/*.md` at the plugin root, read by the agents: the decisions-ledger spec (v0.28), the interview
