---
description: Align an existing, misaligned codebase — invoke the codebase-rescue skill.
---
Use the **codebase-rescue** skill — by name. Every host resolves a skill by name, so this command
never needs to know where the skill lives, and there is nothing here for two hosts to disagree
about.

Start at Phase 1 (comprehension + finding) and build the pinned map — do NOT jump straight to fixes.
