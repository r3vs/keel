<!-- GENERATED FILE - do not edit. Source: src/core/landing-zone.md at the repo root; regenerate with: python scripts/build.py -->
...
the ledger records both levels rather than blending them (`references/core/trust-axes.md`). The runtime computes
