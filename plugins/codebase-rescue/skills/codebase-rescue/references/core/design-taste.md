<!-- GENERATED FILE - do not edit. Source: src/core/design-taste.md at the repo root; regenerate with: python scripts/build.py -->
...
lives on the other side of the fp-check line: a read-only lens (`references/core/agents.md`) producing
