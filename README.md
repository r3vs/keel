...
[![tests](https://img.shields.io/badge/tests-1350%20passing-brightgreen)](.github/workflows/ci.yml)
...
backend that degrades to the stdlib parsers when absent), 73 MCP tools, **1350 tests green in CI**
