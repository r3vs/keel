...
[![tests](https://img.shields.io/badge/tests-963%20passing-brightgreen)](.github/workflows/ci.yml)
...
|---|---|---|
| **[`keel-core`](plugins/keel-core/README.md)** | the spine — auto-installed as a dependency of the other three | **60 MCP tools** · 6 agents · 2 hooks · 2 skills · 4 MCP servers |
...
### The engine: 33 modules, 8.4k lines, Python stdlib only — reaching your agent as 60 typed MCP tools
...
<details>
<summary><b>All 60 tools</b></summary>
...
Design-complete across 2 methodology skills + 14 composable ones, with the runtime **largely
implemented**: 33 modules, 60 MCP tools, **963 tests green in CI**, 4 hosts.
